    ...
    return (
      <div className={`${type} ${basis} ${grow} flex-row items-center`}>
        ...
        <select
          ...
          ref={ref}
          name={name}
          className="block basis-3/4 w-full bg-gray-800 rounded-md border-0 px-3.5 py-2.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 sm:max-w-xs"
          {...selectProps}
          {...props}
        >
          {placeholder && (
